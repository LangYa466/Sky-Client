...
public class ChunkPosComparator implements Comparator<ChunkCoordIntPair>, Serializable {
    ...
    public ChunkPosComparator(int chunkPosX, int chunkPosZ, double yawRad, double pitchRad)
    {
        ...
        this.yawRad = yawRad;
        this.pitchNorm = 1.0D - MathHelper.clamp_double(Math.abs(pitchRad) / (Math.PI / 2.0D), 0.0D, 1.0D);
    }

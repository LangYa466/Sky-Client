...
//        System.out.println("TODO: Implement Display.create(PixelFormat)"); // TODO
    ...
    public static void create() {
        ...
        glfwWindowHint(GLFW_MAXIMIZED, false ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_FOCUSED, true ? GLFW_TRUE : GLFW_FALSE);
        displayFocused = true;
        glfwWindowHint(GLFW_ICONIFIED, false ? GLFW_TRUE : GLFW_FALSE);
        displayVisible = !false;
        glfwWindowHint(GLFW_DECORATED, true ? GLFW_TRUE : GLFW_FALSE);

        glfwWindowHint(GLFW_SRGB_CAPABLE, false ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_DOUBLEBUFFER, true ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_CONTEXT_NO_ERROR, false ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_OPENGL_DEBUG_CONTEXT, false ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_OPENGL_DEBUG_CONTEXT, false ? GLFW_TRUE : GLFW_FALSE);
        ...
        Window.scrollCallback = new GLFWScrollCallback() {
            ...
            public void invoke(long window, double xoffset, double yoffset) {
                Mouse.addWheelEvent(xoffset,yoffset);
            }
        };
    ...
    public static void setTitle(String titleIn) {
        windowTitle = titleIn;
        glfwSetWindowTitle(getWindow(), titleIn);
    }

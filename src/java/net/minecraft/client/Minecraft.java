...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Client.NAME + " | " + "LWJGL " + Sys.getVersion());
    }
    ...
    public void refreshResources(boolean language)
    {
        ...
        try
        {
            this.mcResourceManager.reloadResources(list, language);
        }
...
//                        }
    ...
    public void rightClickMouse() {
        if (!this.playerController.func_181040_m()) {
            ...
            if (ViaMCP.getInstance().getVersion() <= ProtocolVersion.v1_8.getVersion()&& !this.gameSettings.keyBindUseItem.isKeyDown() ) {
                this.thePlayer.swingItem();
            }
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                {
                    Client.INSTANCE.getEventManager().call(new EventKey(k));
                    KeyBinding.onTick(k);
                }
    ...
    //    EventManager.call(new TickEvent());
        ...
        Client.INSTANCE.getEventManager().call(new EventTick());
    }
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
    {
        ...
        theCrash.getCategory().addCrashSectionCallable("Type", new Callable<String>()
        {
            public String call() throws Exception
            {
                return "SkyClient (map_client.txt)";
            }
        });

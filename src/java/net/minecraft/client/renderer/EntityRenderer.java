...
import dev.sky.events.impls.render.EventShader;
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            for (Entity entity1 : list) {
                float f1 = entity1.getCollisionBorderSize() + (0);
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null)
                {
                    ...
                    GlStateManager.pushMatrix();
                    Client.INSTANCE.getEventManager().call(new EventRender2D(partialTicks, EventState.PRE));
                    GlStateManager.popMatrix();

                    GlStateManager.pushMatrix();
                    Client.INSTANCE.getEventManager().call(new EventShader());
                    GlStateManager.popMatrix();

                    GlStateManager.pushMatrix();
                    Client.INSTANCE.getEventManager().call(new EventRender2D(partialTicks, EventState.POST));
                    GlStateManager.popMatrix();

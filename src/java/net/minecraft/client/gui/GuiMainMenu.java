...
public class GuiMainMenu extends GuiScreen {
    ...
    private static final ResourceLocation[] titlePanoramaPaths = {
            new ResourceLocation("skyclient/bg/panorama_0.png"),
            new ResourceLocation("skyclient/bg/panorama_1.png"),
            new ResourceLocation("skyclient/bg/panorama_2.png"),
            new ResourceLocation("skyclient/bg/panorama_3.png"),
            new ResourceLocation("skyclient/bg/panorama_4.png"),
            new ResourceLocation("skyclient/bg/panorama_5.png")};
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, p_73969_1_ + p_73969_2_ + p_73969_2_, "自定义背景"));
    }
    ...
    //    this.drawCenteredString(this.fontRendererObj, this.splashText, 0, -8, -256); ...
        ...
        FontManager.pingfang50.drawCenteredStringWithShadow("SkyClient", width / 2.0,height / 3.5, -1);

...
public class ConnectedProperties
{
    ...
    private static int parseFace(String str)
    {
        ...
        if (!"bottom".equals(str) && !"down".equals(str))
        {
            if (!"top".equals(str) && !"up".equals(str))
            {
                if ("north".equals(str))
                {
                    return 4;
    ...
    private static int parseMethod(String str)
    {
        ...
        else
        {
            ...
            if (!"ctm".equals(str) && !"glass".equals(str))
            {
                if ("ctm_compact".equals(str))
                {
                    return 10;
                }
                else if (!"horizontal".equals(str) && !"bookshelf".equals(str))
                {
                    ...
                    else if (!"horizontal+vertical".equals(str) && !"h+v".equals(str))
                    {
                        if (!"vertical+horizontal".equals(str) && !"v+h".equals(str))
                        {
                            if ("overlay".equals(str))
                            {
                                return 11;
                            }
                            else if ("overlay_fixed".equals(str))
                            {
                                return 12;
                            }
                            else if ("overlay_random".equals(str))
                            {
                                return 13;
                            }
                            else if ("overlay_repeat".equals(str))
                            {
                                return 14;
                            }
                            else if ("overlay_ctm".equals(str))
                            {
                                return 15;
                            }
                            else
